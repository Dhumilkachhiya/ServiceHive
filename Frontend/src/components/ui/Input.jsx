    ...
    return (
        <div className={cn("flex flex-col gap-1.5", className)}>
            ...
            <input
                ...
                min={min}
                max={max}
                className={cn("px-4 py-3 rounded-2xl bg-gray-50 dark:bg-petal-muted/30 border border-gray-100 dark:border-petal-leaf/10 text-petal-moss dark:text-white focus:outline-none focus:border-petal-rose focus:ring-2 focus:ring-petal-rose/20 transition-all duration-300 placeholder-gray-400 text-sm shadow-inner", inputClassName)}
            />
        </div>
    );
}
